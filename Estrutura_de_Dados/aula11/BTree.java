...
public class BTree<T> {   
   ...
   // Número de folhas da árvore
    ...
    private boolean strict(BTNode<T> n) {
       if (n == null) return true; // árvore vazia é estritamente binária
       if (n.getLeft() == null && n.getRight() == null) return true; // folha
       if (n.getLeft() != null && n.getRight() != null) {
          return strict(n.getLeft()) && strict(n.getRight());
       }
       return false; // só tem um filho -> não é estritamente binária
    }
    ...
    public T path(String s) {
       ...
       if (s.equals("R")) return cur.getValue(); // raiz

       for (int i = 0; i < s.length(); i++) {
          char c = s.charAt(i);
          if (c == 'E') cur = cur.getLeft();
          else if (c == 'D') cur = cur.getRight();
       }
       return cur.getValue();
    }
    ...
    // Devolve o número de nós no nível de profundidade k
